...
OPSI 1: EXECUTABLE MANDIRI (LANRemoteClient.exe) - TERMUDAH & 100% OFFLINE
 ...
 Langkah-langkah:
  1. Salin file `LANRemoteClient.exe` dan `config.json` ke PC target
...
OPSI 3: PEMASANGAN OFFLINE MENGGUNAKAN WHEELS (offline_packages)
 ...
 Langkah-langkah:
  1. Di folder `offline_packages` sudah disediakan file-file library `.whl`
...
Langkah-langkah:
 ...
 3. Beri izin eksekusi dan jalankan script installer:
      ...
      ./install_linux.sh
    - FITUR OFFLINE: Folder 'client/offline_packages' sudah menyertakan paket wheel
      binary Linux x86_64 ('manylinux2014_x86_64') untuk Python 3.10 (Ubuntu 22.04 LTS)
